...
import practicaltest02var03.eim.systems.cs.pub.ro.practicaltest02var03.R;
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case  R.id.start_client_button:
                    ...
                    if (query.isEmpty()) {
                        Toast.makeText(getApplicationContext(), "Query can't be null!", Toast.LENGTH_SHORT).show();
                        return;
                    }
